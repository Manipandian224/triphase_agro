    ...
    <div className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-5xl h-[700px] bg-white/5 backdrop-blur-2xl border border-white/10 shadow-lg rounded-2xl overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2 h-full">
          ...
          {/* Right Panel: Form */}
          <div className="flex flex-col justify-center p-8 sm:p-12 text-slate-100 bg-background/30 md:bg-transparent">
...
const SocialButton = ({ provider }: { provider: 'Google' | 'Facebook' }) => {
  ...
  return (
    <Button 
      variant="outline" 
      className="h-12 flex-1 bg-black/20 border-white/20 hover:bg-black/30 text-slate-200"
    >
      <Icon />
